...
<div class="box tip"><b>เวลาทำโจทย์แปลงรูป</b> เขียนทีละบรรทัดพร้อม<b>ระบุชื่อกฎ</b>ที่ใช้ข้าง ๆ ห้ามข้ามขั้น เพราะถ้าผิดจะย้อนหาจุดผิดไม่เจอ</div>` },
    ...
    { type: "p", html: "<b>กฎการเปลี่ยนรูป</b> คือชุดกฎที่ใช้แปลงประพจน์ให้อยู่ในรูปที่ง่ายขึ้นโดยค่าความจริง<b>ไม่เปลี่ยน</b> — ทุกกฎด้านล่างตรวจด้วยตารางค่าความจริงครบทุกแถวแล้ว",
...
<div class="box tip"><b>จำคู่กับข้อ ④</b> ตัวเชื่อมข้างนอกแจกเข้าไปหาทั้งสองตัวข้างใน แล้วตัวเชื่อมข้างในกลายเป็นตัวเชื่อมข้างนอก — สลับบทบาทกันพอดี</div>

<h4>⑥ กฎนิจพล และกฎการดูดกลืน</h4>
<table><tr><th>ชื่อกฎ</th><th>รูป</th><th>ใช้ตอนไหน</th></tr>
<tr><td>นิจพล (idempotent)</td><td>p ∧ p ≡ p &nbsp;·&nbsp; p ∨ p ≡ p</td><td>ตัวซ้ำกันยุบเหลือตัวเดียว</td></tr>
<tr><td>การดูดกลืน (absorption)</td><td>p ∨ (p ∧ q) ≡ p &nbsp;·&nbsp; p ∧ (p ∨ q) ≡ p</td><td>เห็น p ซ้ำสองชั้น ตัดวงเล็บทิ้งได้เลย</td></tr></table>
<div class="box why"><b>ทำไมการดูดกลืนถึงจริง</b><br>ถ้า p เป็นจริง ทั้งก้อนก็จริงอยู่แล้วไม่ว่า q จะเป็นอะไร · ถ้า p เป็นเท็จ ทั้งก้อนก็เท็จอยู่ดี — q จึงไม่มีผลเลย</div>

<h4>⑦ ประพจน์ที่จับคู่กับ T หรือ F</h4>
<p>T แทนประพจน์ที่จริงเสมอ (สัจนิรันดร์) · F แทนประพจน์ที่เท็จเสมอ (ข้อขัดแย้ง)</p>
...
<div class="box tip"><b>อ่าน ~(p ↔ q) เป็นภาษาคน</b> คือ “สองตัวนี้มีค่าความจริงต่างกัน” — ตัวหนึ่งจริงอีกตัวเท็จ</div>

<h4>⑩ กฎที่ใช้กับ → เมื่อหน้าหรือหลังเป็นก้อน</h4>
...
<div class="box tip">กฎเดิมทุกประการ แค่แจกนิเสธเข้าไปให้ครบทุกตัวแล้วพลิกตัวเชื่อมทุกตัว</div>`
    ...
    { type: "p", html: "<b>ฝึกลดรูป</b> — โจทย์แปลงรูปที่ออกสอบจริงมักลดได้เหลือสั้นมาก ถ้าเลือกกฎถูกลำดับ",
...
<p class="frm">(p ∨ q) ∧ (p ∨ ~q)</p>
<table><tr><th>บรรทัด</th><th>กฎที่ใช้</th></tr>
<tr><td>≡ p ∨ (q ∧ ~q)</td><td>แจกแจงย้อนกลับ &nbsp;[กฎข้อ ⑤]</td></tr>
...
<tr><td>④</td><td>ยุบคู่ที่กลายเป็น T หรือ F ด้วยกฎข้อ ⑦ และ ⑧</td></tr></table>
