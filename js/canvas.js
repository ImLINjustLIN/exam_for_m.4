...
const DiagramNote = (() => {
  ...
  function buildUI() {
    ...
    /* กระดานหลัก: เริ่มที่ "เลือก/ย้าย" จะได้ลากการ์ดได้ทันทีโดยไม่เผลอวาดทับ
       กระดานทดในข้อสอบ: เริ่มที่ "ปากกา" เพราะเปิดมาเพื่อเขียนอย่างเดียว
       (เคยเป็นบั๊ก — เปิดกระดานทดแล้วเขียนไม่ได้ เพราะเครื่องมือค้างที่ลูกศร) */
    setTool(padMode ? "pen" : "select");
    updateSwatch();
